    ...
    try {
      ...
      await apiCall({
        ...
        summaryData: {
          ...
          totalKm,
          bateria: reportData?.counts?.bateriaBaixa || 0,
          manutBike: reportData?.counts?.manutencaoBicicleta || 0,
          manutLocker: reportData?.counts?.manutencaoLocker || 0,
          solicitadoRecolha: reportData?.counts?.solicitadoRecolha || 0,
          remanejadas: reportData?.remanejadas?.length || 0,
          ocorrencias: reportData?.ocorrencias?.length || 0,
          naoEncontradas: reportData?.naoEncontrada?.length || 0,
          vandalizadas: reportData?.vandalizadas?.length || 0,
